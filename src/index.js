...
function createProgressDisplay() {
  ...
  const gameResult1 = displayGameResults();
  const gameResult2 = displayGameResults();
  progress.appendChild(gameProgress1);
  progress.appendChild(gameProgress2);

  progress.appendChild(gameResult1)
  progress.appendChild(gameResult2);
}
...
function displayGameResults() {
  const progressDiv = document.createElement('div');
  progressDiv.classList.add('result_chart');
  return progressDiv;
}
